...
export default function NewCardPage() {
  ...
  const handleFormSuccess = () => {
    // Optionally, navigate away or show a persistent success message here too
    // For now, the form itself handles displaying success and resetting.
    // router.push('/dashboard/cards');
    console.log("NewCardForm submitted successfully from page");
  };
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ mb: 3 }}>
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Link href="/dashboard/cards" passHref style={{ color: theme.palette.text.primary, textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
